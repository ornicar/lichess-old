...
class Game implements Model\Game
{
    ...
    public function setWinner(Model\Player $player)
    {
     ...
     * @return null
     */
    public function setClock(Model\Clock $clock = null)
    {
        if($this->getIsStarted()) {
    ...
    public function setCreator(Model\Player $player)
    {
    ...
    public function addPlayer(Model\Player $player)
    {
