...
<div class="game_list" data-url="<?php echo $view['router']->generate('lichess_list_current_inner', array('ids' => implode(',', $ids))) ?>">
<?php echo $view['actions']->render('LichessBundle:Game:listCurrentInner', array('ids' => $ids)) ?>
</div>
