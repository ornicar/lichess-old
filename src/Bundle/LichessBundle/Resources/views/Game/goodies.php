<div class="lichess_goodies">
    ...
    <a class="lichess_replay_link" target="blank" href="<?php echo $view->router->generate('lichess_pgn_viewer', array('hash' => $game->getHash(), 'color' => 'white')) ?>"><?php echo $view->translator->_('Replay and analyse') ?></a>
</div>
