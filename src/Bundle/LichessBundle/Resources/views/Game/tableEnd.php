...
<div class="lichess_table finished <?php echo $game->getNext() ? ' lichess_table_next' : '' ?>">
    ...
    <div class="lichess_control clearfix">
        ...
        <?php if(!$opponent->getIsAi()): ?>
            ...
            <?php else: ?>
                <a class="lichess_rematch" title="Play with the same opponent again" href="<?php echo $view->router->generate('lichess_rematch', array('hash' => $player->getFullHash())) ?>">Rematch</a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
</div>
