...
<div class="lichess_game_not_started waiting_opponent clearfix lichess_player_<?php echo $color ?>">
    <div class="lichess_board_wrap">
        ...
        <div class="lichess_overboard wait_anybody">
            ...
            <a class="join_redirect_url" href="<?php echo $view['router']->generate('lichess_join_game', array('hash' => $game->getHash())) ?>"><img src="<?php echo $view['assets']->getUrl('/bundles/lichess/images/hloader.gif') ?>" /></a>
        </div>
    </div>
</div>
