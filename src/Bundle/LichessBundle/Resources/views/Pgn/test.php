...
<script src="/bundles/lichess/vendor/pgn4web/pgn4web.js" type="text/javascript"></script>
<script type="text/javascript">
   SetImagePath ("/bundles/lichess/vendor/pgn4web/alpha/48"); // use "" path if images are in the same folder as this javascript file
   SetImageType("png");
