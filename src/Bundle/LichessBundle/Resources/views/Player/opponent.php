...
<a title="<?php echo $view['translator']->_('Make your opponent resign') ?>" class="force_resignation" href="<?php echo $view['router']->generate('lichess_force_resignation', array('id' => $player->getFullId())) ?>"><?php echo $view['translator']->_('Force resignation') ?></a>
<?php endif; ?>
