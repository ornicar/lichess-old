...
<div class="lichess_game clearfix lichess_player_<?php echo $player->getColor() ?> not_spectator">
    ...
    <div class="lichess_ground">
        ...
        <div class="lichess_table_wrap">
            <?php $view->actions->output('LichessBundle:Player:table', array('path' => array('hash' => $player->getGame()->getHash(), 'color' => $player->getColor(), 'playerFullHash' => $player->getFullHash()))) ?>
        </div>
