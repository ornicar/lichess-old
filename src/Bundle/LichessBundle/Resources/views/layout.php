...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/bundle/lichess/css/lichess.12.css" />
    ...
    <body>
        <div class="content">
            <div class="header">
                <h1>
                    <a class="site_title" href="<?php echo $view->router->generate('lichess_homepage') ?>">Lichess</a><span class="lichess_version">1.4</span>
                </h1>
        ...
        <script src="/bundle/lichess/js/game.11.js" type="text/javascript"></script>
    </body>
</html>
