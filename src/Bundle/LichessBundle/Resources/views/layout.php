...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/bundle/lichess/css/lichess.7.css" />
    ...
    <body>
        ...
        <script src="/bundle/lichess/js/ctrl.5.js" type="text/javascript"></script>
        <script src="/bundle/lichess/js/game.7.js" type="text/javascript"></script>
    </body>
</html>
