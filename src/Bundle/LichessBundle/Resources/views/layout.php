...
<html>
    ...
    <body>
        <div class="content">
            <div class="header">
                ...
                <div class="lichess_social">
                    ...
                    <iframe class="lichess_facebook" src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Flichess.org%2F&amp;layout=standard&amp;show_faces=false&amp;width=58&amp;action=like&amp;font=lucida+grande&amp;colorscheme=light&amp;height=28" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                </div>
        ...
        <script src="/bundle/lichess/js/ctrl.1.js" type="text/javascript"></script>
        <script src="/bundle/lichess/js/game.2.js" type="text/javascript"></script>
    </body>
</html>
