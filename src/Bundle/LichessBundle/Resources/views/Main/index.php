...
<div class="lichess_game_not_started clearfix lichess_player_<?php echo $color ?>">
    <div class="lichess_board_wrap">
        ...
        <a href="<?php echo $view->router->generate('lichess_homepage', array('color' => 'white' === $color ? 'black' : 'white')) ?>" class="lichess_exchange" title="<?php echo $view->translator->_('Change position') ?>"></a>
    </div> 
