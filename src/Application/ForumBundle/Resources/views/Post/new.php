...
<form action="<?php echo $view['router']->generate('forum_topic_post_create', array('categorySlug' => $topic->getCategory()->getSlug(), 'slug' => $topic->getSlug(), 'id' => $topic->getId())) ?>#reply" method="post">
