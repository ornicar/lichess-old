...
class UpdateCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $topics = $this->getContainer()->get('forum.repository.topic')->findAll();
        $topicUpdater = $this->getContainer()->get('forum.updater.topic');
        ...
        $categorys = $this->getContainer()->get('forum.repository.category')->findAll();
        $categoryUpdater = $this->getContainer()->get('forum.updater.category');
